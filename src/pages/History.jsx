...
export default function History() {
  ...
  const handleDayClick = async (dateStr) => {
    ...
    setSelectedSessionData({ session, sets: sets || [], volume: vol });
  };
          ...
          <div className="bg-[#121212] border border-neutral-900 rounded-3xl overflow-hidden animate-fade-in shadow-lg">
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <div className="text-[10px] font-black text-neutral-500 tracking-wider uppercase mb-1">Total Vol</div>
                  <div className="text-xl font-black text-white font-display">
            ...
            <div className="p-5">
              {selectedSessionData.sets.length === 0 ? (
                <p className="text-neutral-500 text-xs text-center py-6 font-bold uppercase tracking-wider">No logged sets found for session</p>
              ) : (
                <ExerciseSetsView sets={selectedSessionData.sets} />
              )}
            </div>
          </div>
        )}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-[10px] text-neutral-500 font-bold uppercase tracking-wider leading-none mb-1.5">{formatDate(s.session_date)}</div>
                      <div
...
// Group sets by exercise and display
function ExerciseSetsView({ sets }) {
  const byExercise = {};
  sets.forEach((s) => {
  ...
  return (
    <div className="space-y-4">
      {Object.entries(byExercise).map(([name, exSets]) => (
        <div key={name} className="border-b border-neutral-900 last:border-0 pb-3 last:pb-0">
          <div className="text-xs font-black text-white uppercase tracking-wider mb-2.5">{name}</div>
